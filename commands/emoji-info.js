...
module.exports = {
  ...
  run: async (bot, message, args) => {
	...
	if(!message.guild.me.hasPermission("MANAGE_EMOJIS")) return message.channel.send('<a:no:997879343999111280> **I do not have the correct permissions | Permission : MANAGE_EMOJIS**')
