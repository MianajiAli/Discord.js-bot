...
module.exports = {
    ...
    async run (client, message, args) {
		if(!message.member.hasPermission("MANAGE_ROLES")) return message.channel.send('<a:alert:995652726543355975> **You can not use this command | Permission: MANAGE_ROLES**')
            ...
            message.channel.send(`<a:verify:995645296736481320> **All the members now have the ${role} role**`)
        }
}