...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (!args[0]) return message.channel.send('<a:no:997879343999111280> **You did not specify a time**')
        ...
        if (isNaN(time)) return message.channel.send('<a:no:997879343999111280> **Not a valid time, please try again**')

        if (time >= 21600) return message.channel.send('<a:no:997879343999111280> **That slowmode limit is too high, please enter anything lower than 6 hours**')
