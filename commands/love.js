...
module.exports = {
    ...
    if(!target) return message.channel.send("<a:no:997879343999111280> **Please mention someone**")
    if(target.id == message.author.id) return message.channel.send("<a:no:997879343999111280> **Please mention someone else**")
