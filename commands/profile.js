...
module.exports = {
    ...
    async run (client, message, args) {
		...
		if (ghost === null) ghost = `<a:no:997879343999111280>`;
		if (ninja === null) ninja = `<a:no:997879343999111280>`;
		if (mind === null) mind = `<a:no:997879343999111280>`;
		if (invis === null) invis = `<a:no:997879343999111280>`;
		if (copper === null) copper = `<a:no:997879343999111280>`;
		if (bronze === null) bronze = `<a:no:997879343999111280>`;
		if (silver === null) silver = `<a:no:997879343999111280>`;
		if (gold === null) gold = `<a:no:997879343999111280>`;
		if (diamond === null) diamond = `<a:no:997879343999111280>`;
		if (immortal === null) immortal = `<a:no:997879343999111280>`;
		if (bal === null) bal = 0;
		...
		.addField('Money', `**${(bal).toLocaleString()} 🪙**`, true)
