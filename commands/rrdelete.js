...
module.exports = {
    ...
    async run (client, message, args) {
		...
		if(!args[0]) return message.channel.send(`<a:no:997879343999111280> **${prefix}rrdelete <messageid> <emoji>**`)
    ...
    if(!channel) return message.channel.send(`<a:no:997879343999111280> **Message ID Not Found**`)
    if(!messageid) return message.channel.send(`<a:no:997879343999111280> **MessageID Not Found**`)
    let a = client.channels.cache.get(channel).messages.fetch(args[0])
   if(!a) return message.channel.send(`<a:no:997879343999111280> **That's Message ID Is Invaild**`)
   if(!args[1]) return message.channel.send(`<a:no:997879343999111280> **${prefix}rrdelete <messageid> <emoji>**`)
   ...
   if(!emote) return message.channel.send(`<a:no:997879343999111280> **theres no emojis with ${emojicheck} on ${args[0]}**`)
