...
module.exports = {
    ...
    async run (client, message, args) {
		try {
            ...
            if (title.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled')
            ...
            if (Author.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled')
            ...
            if (Description.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled')
            ...
            if (Thumbnail.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled ')
            ...
            if (Image.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled ')
            ...
            if (Color.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled')
            ...
            if (Footer.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled ')
            ...
            if (TimeStamp.first().content == 'cancel') return message.channel.send('<a:no:997879343999111280> **Embed Cancelled**')
